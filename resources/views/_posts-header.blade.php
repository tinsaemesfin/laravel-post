<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <x-dropdown>
            ...
            {{-- class="block px-3 text-left text-sm leading-6 
            hover:bg-gray-300 focus:bg-gray-300{{ isset($current_category)&& $current_category->id==$category->id?'bg-blue-500 text-white':'' }}" --}}
